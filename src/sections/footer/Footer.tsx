			...
			<div className='py-14 px-10 lg:px-0 lg:py-28 flex flex-col lg:flex-row justify-evenly items-start gap-10 lg:gap-0'>
				<div className=''>
					...
					<ul className='flex flex-col justify-start items-start gap-2 text-sm'>
						<li>
							<Link href='/about-us' title='Drozee Overview' aria-label='Drozee Overview'>
								Drozee Overview
							</Link>
						</li>
						<li>
							<Link href='/dashboard' title='Learn Path' aria-label='Learn Path'>
								LearnPath
							</Link>
						</li>
						<li>
							<Link href='/dashboard' title='StepDegree' aria-label='StepDegree'>
								StepDegree
							</Link>
						</li>
						<li>
							<Link href='/dashboard' title='Skill Match' aria-label='Skill Match'>
								Skill Match
							</Link>
						</li>
						<li>
							<Link href='/dashboard' title='TopSlot' aria-label='TopSlot'>
								TopSlot
							</Link>
						</li>
					</ul>
				...
				<div className=''>
					...
					<ul className='flex flex-col justify-start items-start gap-2 text-sm'>
						...
						<li>
							<Link href='/career' title='Career' aria-label='Career'>
								Career
							</Link>
						</li>
						<li>
							<Link href='/dashboard' title='Spotlight' aria-label='Spotlight'>
								Spotlight
							</Link>
						</li>
						<li>
							<Link href='/under-development' title='Customer Stories' aria-label='Customer Stories'>
								Customer Stories
							</Link>
						</li>
						<li>
							<Link href='/under-development' title='Our Heroes' aria-label='Our Heroes'>
								Our Heroes
							</Link>
						</li>
						<li>
							<Link href='/under-development' title='Pricing' aria-label='Pricing'>
								Pricing
							</Link>
						</li>
					</ul>
				...
				<div className=''>
					...
					<ul className='flex flex-col justify-start items-start gap-2 text-sm'>
						<li>
							<Link href='/under-development' title='Help Center' aria-label='Help Center'>
								Help Center
							</Link>
						</li>
						<li>
							<Link href='/under-development' title='Blog' aria-label='Blog'>
								Blog
							</Link>
						</li>
						<li>
							<Link href='/under-development' title='Community' aria-label='Community'>
								Community
							</Link>
						</li>
						<li>
							<Link href='/under-development' title='Developers' aria-label='Developer'>
								Developers
							</Link>
						</li>
					</ul>
				...
				<div className=''>
					...
					<ul className='flex flex-col justify-start items-start gap-2 text-sm'>
						<li>
							<Link href='/under-development' title='Academics' aria-label='Academics'>
								Academics
							</Link>
						</li>
						<li>
							<Link href='/under-development' title='Corporates' aria-label='Corporates'>
								Corporates
							</Link>
						</li>
						<li>
							<Link href='/under-development' title='Recruiters' aria-label='Recruiters'>
								Recruiters
							</Link>
						</li>
						<li>
							<Link href='/under-development' title='Startups' aria-label='Startups'>
								Startups
							</Link>
						</li>
					</ul>
